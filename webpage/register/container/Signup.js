            ...
            <Content>
              <Form>
                ...
                <Item floatingLabel>
                  ...
                  <Input value={this.state.personalId} onChangeText={text => this.setField("personalId", text)} maxLength={13} />
                </Item>
                <Item floatingLabel>
                  <Label>Laser Code</Label>
                  <Input value={this.state.laserCode} onChangeText={text => this.setField("laserCode", text)} />
                </Item>
                <Item floatingLabel>
                  <Label>Phone number</Label>
                  <Input value={this.state.phonenumber} onChangeText={text => this.setField("phonenumber", text)} maxLength={10} />
                </Item>
                <Item>
                  <Label>Gender</Label>
                  <Picker selectedValue={this.state.gender} style={{ height: 75, width: 200 }} onValueChange={value => this.setState(
                        { gender: value }
                      )}>
                ...
                <Item floatingLabel>
                  <Label>Address</Label>
                  <Input value={this.state.address} onChangeText={text => this.setField("address", text)} />
                </Item>
                <Item>
                  <Label>Country</Label>
                  <Picker selectedValue={this.state.countryId} style={{ height: 75, width: 200 }} onValueChange={value => this.setState(
                        { countryId: value }
                      )}>
                    {this.initialCountry()}
                  </Picker>
                ...
                <Item floatingLabel>
                  <Label>State</Label>
                  <Input value={this.state.state} onChangeText={text => this.setField("state", text)} />
                </Item>
                <Item floatingLabel>
                  <Label>City</Label>
                  <Input value={this.state.city} onChangeText={text => this.setField("city", text)} />
                </Item>
                <Item floatingLabel>
                  <Label>Zipcode</Label>
                  <Input value={this.state.zipcode} onChangeText={text => this.setField("zipcode", text)} />
                </Item>
                <Button dark style={{ justifyContent: "center", alignSelf: "stretch", marginTop: 20 }}>
                  <Text style={{ fontSize: 30 }}>
